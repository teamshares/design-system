...
const buildDefaultConfig = (customRules) => {
  ...
  return [
    ...
    {
      files: ["app/frontend/javascript/test/**/*.js", "app/frontend/javascript/**/*.test.js"],
      ...jestConfig,
    },
    {
      files: ["app/frontend/**/*.{js,jsx,ts,tsx}"], // NOTE: covers javascripts/ + component controllers
      ignores: [
        "app/frontend/javascript/controllers/index.js", // Autogenerated, don't bother parsing
      ],
      ...browserConfig,
    },
  ];
